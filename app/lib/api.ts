...
export const expenseApi = {
  getEntries: (params?: { limit?: number; offset?: number }) => {
    ...
    return apiRequest<{ success: boolean; expenses: any[] }>(`/api/expense-entries${queryString ? `?${queryString}` : ''}`);
  },
...
export const incomeApi = {
  getEntries: (params?: { limit?: number; offset?: number }) => {
    ...
    return apiRequest<{ success: boolean; entries: any[] }>(`/api/income-entries${queryString ? `?${queryString}` : ''}`);
  },
